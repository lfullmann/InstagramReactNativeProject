    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 4, width: "100%", justifyContent: "center" }}>
        <ScrollView style={{ width: "100%" }}>
          <Image
            style={{ height: 250, width: 370, alignSelf: "center" }}
          ...
          <Text style={{ marginBottom: 9, width: 370, alignSelf: "center" }}>
            Nullam lorem ante, pellentesque tempor ornare vehicula, finibus sed
            sem. Fusce finibus tempus dolor, ut pellentesque enim gravida nec.
            Suspendisse rutrum purus eu tincidunt semper.
          </Text>
          ...
          <Text style={{ marginBottom: 9, width: 370, alignSelf: "center" }}>
            ...
            lacinia nisi non elit gravida, eu bibendum enim varius. Donec
            molestie, nunc sit amet tincidunt accumsan, libero eros finibus
            erat, consequat pretium risus tellus et ligula.
          </Text>
        </ScrollView>
      </View>
